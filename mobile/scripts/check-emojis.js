...
/**
 * Emoji detection script for TradeByBarter Mobile App
...
function main() {
  ...
  if (totalEmojis > 0) {
    console.error('\n\MOBILE APP EMOJI POLICY VIOLATION DETECTED!');
    console.error('==========================================');
    ...
    console.error('TradeByBarter Mobile App has a ZERO-TOLERANCE policy for emojis.');
    ...
    if (!isQuiet) {
      console.log('Mobile App: No emojis detected. All clear!');
    }
    process.exit(0);
  }
}
